...
<div class="px-5 py-4 shadow text-black rounded-3" style="background-color: white;font-size: 0.9rem;">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-8 ">
            <input type="text" class="form-control ml-3" name="nama" id="nama" value="<?= $barang['nama_brh']; ?>">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-8">
            <input type="datetime-local" class="form-control ml-3" name="tanggal" id="tanggal" value="<?= date('Y-m-d\TH:i', $tgl_hilang['tgl']); ?>">
